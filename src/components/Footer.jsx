  ...
  return (
    <footer className="border-t border-white/10 bg-foreground text-background">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-white/15 pt-7 text-xs text-background/75 sm:flex-row sm:items-center sm:justify-between"><p>&copy; 2026 Tree Services Clarence. All rights reserved.</p><div className="flex flex-wrap gap-5"><Link to="/privacy-policy" className="transition hover:text-white">Privacy Policy</Link><Link to="/terms-conditions" className="transition hover:text-white">Terms & Conditions</Link><a href="tel:+17165892600" className="transition hover:text-white">Emergency Service</a></div></div>
      </div>
    </footer>
  );
}
